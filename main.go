...
import (
	"flag"
	"github.com/meixiezichuan/clustertopology/server"
	"os"
	...
	"github.com/meixiezichuan/clustertopology/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f45900c3.fdse.lab",
	})
	if err != nil {
